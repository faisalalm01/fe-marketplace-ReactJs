...
const AddProduct = () => {
  ...
  useEffect(() => {
    ...
    // Buat permintaan GET ke endpoint keranjang
    axios
      .get(import.meta.env.VITE_BASE_URL + "user/product", { headers })
      .then((response) => {
                          ...
                          <div className="mt-2">
                            <div className="px-2 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 sm:max-w-md bg-white">
                              <input
                                ...
                                onChange={handleInputChange}
                                className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                placeholder="Harga produk mu"
                              />
                              - harga harus termasuk ongkir
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="sm:col-span-3">
                          ...
                          <div className="mt-2">
                            <select
                              ...
                              onChange={handleInputChange}
                              className="block w-full rounded-md border-0 py-1.5 bg-white px-3 text-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                            >
