...
const NotFound = () => {
  return (
    <section className="">
  <section className="relative z-10 bg-primary py-[120px] text-black my-auto mx-auto container">
          ...
          <div className="flex -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[400px] text-center">
                ...
                <a
                  href="/#"
                  className="inline-block px-8 py-3 text-base font-semibold text-center transition border border-white rounded-lg hover:bg-white hover:text-primary"
                >
                  Go to Home
                </a>
              </div>
